...
class ProductController extends Controller
{
    ...
    public function getProduct(){
        $data['productlist'] = DB::table('mc_products')
        ->join('mc_categories','mc_products.prod_cate','=','mc_categories.cate_id')
