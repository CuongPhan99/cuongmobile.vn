...
<title>@yield('title') | CuongMobile Shop</title>
...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
            ...
            <a class="navbar-brand" href="{{asset('admin/home')}}">CuongMobile Admin</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
            ...
            <li><a href="{{asset('admin/product')}}"><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"></use></svg> Sản phẩm</a></li>
            <li><a href="{{asset('admin/category')}}"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"></use></svg> Danh mục</a></li>
            <li><a href="{{asset('admin/user')}}"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Người dùng</a></li>
            <li><a href="{{asset('admin/order')}}"><svg class="glyph stroked bag"><use xlink:href="#stroked-bag"></use></svg> Đơn hàng</a></li>
			<li role="presentation" class="divider"></li>
		</ul>
