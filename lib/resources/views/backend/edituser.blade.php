                            ...
                            <div class="row" style="margin-bottom:40px">                               
								<div class="col-xs-8">
									...
									<div class="form-group" >
										...
										<select required name="sex" class="form-control" value="{{$user->sex}}">
											<option>Nam</option>
											<option>Nữ</option>
					                    </select>
									</div>
									...
									<div class="form-group" >
										...
										<input required type="text" name="password" class="form-control" value="{{$user->password}}">
									</div>
									<div class="form-group" >
										<label>Cấp</label>
										<select required name="level" class="form-control" value="{{$user->level}}">
											<option>1</option>
                                            <option>2</option>
                                            <option>3</option>
					                    </select>
